...
Tyrance has given a TEDx talk and been featured in publications like Forbes, Blavity, CNN Business and Black Enterprise. His thought leadership on AI and emerging technologies has led to him testifying before the United States Senate HELP committee on AI and the Future of Work, attending the historic signing of the AI Executive Order at the White House, addressing a caucus meeting on AI and civil rights, and hosting the White House National Cyber Director Harry Coker Jr. and his team in historic Greenwood.`,
  ...
  },
  {
    ...
    shortBio: "Josephine Nelms leads the operational strategy, partnerships and organizational systems that power Black Tech Street's mission. A Tulsa native and University of Tulsa graduate with a B.S. in Biological Sciences and a Minor in Chemistry, she brings more than 15 years of experience in operations, HR and organizational leadership.",
...
Sean serves his alma mater, The University of Tulsa, as a Trustee and Executive Committee member. He also volunteers on the Executive Committee of the George Kaiser Family Foundation's tech initiative, Tulsa Innovation Labs, an organization committed to fostering Tulsa's innovation economy. With a deep appreciation for the Arts & Humanities, he serves on the Executive Committee of the Board of Trustees at the Philbrook Museum of Art & Gardens.`,
  ...
  },
  {
    ...
    expandedBio: `Dr. Tiffany T. Crutcher is a Tulsa native, community leader, and Executive Director of the Terence Crutcher Foundation. Her work is rooted in transforming history into opportunity by strengthening communities, fostering economic mobility, and creating pathways for long-term prosperity in North Tulsa and beyond.

She is the founder of multiple organizations and coalitions dedicated to community development, policy leadership, mental wellness, and youth advancement, including the Terence Crutcher Foundation and the Tulsa Community Remembrance Coalition. Through these efforts, Dr. Crutcher advances initiatives that honor Greenwood's legacy while building sustainable economic opportunities for future generations.

In partnership with national and local leaders, Dr. Crutcher has led efforts to elevate Tulsa's history on the national stage, including efforts to designate Oklahoma's first national monument and the installation of historical markers in the historic Greenwood District. She also played a key role in bringing President Joe Biden to Tulsa to formally acknowledge the legacy of the 1921 Tulsa Race Massacre.
